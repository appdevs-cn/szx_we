		...
		<tr ng-repeat="permission in permissions" ng-if="permission.uid">
			...
			<td  class="we7-padding-right text-right">
				<div class="link-group">
					...
					<a href="javascript:;" ng-if="permission.isfounder == 0 && (((state == 'founder' || state == 'owner') && (permission.role == 'manager' || permission.role == 'operator')) || (state == 'manager' && permission.role == 'operator') || (state == 'founder' && permission.role == 'owner'))" ng-click="delPermission(permission.uid)">删除 </a>
