...
class QrcodeForm extends Model
{
    ...
    public function save()
    {
        if($this->validate()){
            ...
            $this->qrcode->avatar_size = json_encode($avatar_size,JSON_UNESCAPED_UNICODE);
            $this->qrcode->avatar_position = json_encode($avatar_position,JSON_UNESCAPED_UNICODE);
            $this->qrcode->qrcode_size = json_encode($qrcode_size,JSON_UNESCAPED_UNICODE);
            $this->qrcode->qrcode_position = json_encode($qrcode_position,JSON_UNESCAPED_UNICODE);
            $this->qrcode->font_position = json_encode($font_position,JSON_UNESCAPED_UNICODE);
            $this->qrcode->font = json_encode($font,JSON_UNESCAPED_UNICODE);
