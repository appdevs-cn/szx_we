...
?>
<link href="https://cdn.bootcss.com/jquery-datetimepicker/2.5.12/jquery.datetimepicker.min.css" rel="stylesheet">
<style>
        ...
        <div class="card-block">
            ...
            <div class="mb-3 clearfix">
                ...
                <div class="btn-group mr-5" role="group" aria-label="Basic example">
                    <a href="<?= $urlManager->createUrl(['mch/miaosha/goods']) ?>"
                       class="btn btn-outline-primary">按商品查看</a>
                    <a href="<?= $urlManager->createUrl(['mch/miaosha/calendar']) ?>" class="btn btn-primary">按日历查看</a>
                </div>
