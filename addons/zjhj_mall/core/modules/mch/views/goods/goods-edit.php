            ...
            <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="video-picker" data-url="<?= $urlManager->createUrl(['upload/video']) ?>">
                                ...
                                <div>
                                    <span class="text-danger fs-sm">支持格式mp4;支持编码H.264;视频大小不能超过<?= \app\models\UploadForm::getMaxUploadSize() ?>
                                        MB</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="input-group short-row">
                                <input type="number" step="0.01" class="form-control short-row" name="full_cut[forehead]"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div>请前往商品库存设置库存和价格，<a target="_blank"
                                                       href="<?= $urlManager->createUrl(['mch/goods/goods-attr', 'id' => $goods['id']]) ?>">立即前往</a>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
            ...
            <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    ...
                    <div class="form-group row share-commission">
                        <div class="col-3 text-right">
                            <label class=" col-form-label required">单独分销比例</label>
                        </div>
                        <div class="col-9">
                            <div class="short-row">
                                <div class="input-group mb-3">
                                    <span class="input-group-addon">一级佣金比例（0~100）</span>
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-addon">二级佣金比例（0~100）</span>
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-addon">三级佣金比例（0~100）</span>
