...
<div class="main-body p-3">
    ...
    <table class="table table-bordered bg-white">
        ...
        <?php foreach ($list as $index => $goods): ?>
            <tr>
                <td class="nowrap" style="text-align: left"><span><input data-num="<?= $goods->num ?>" type="checkbox"
                                                                         class="goods-one"
                                                                         value="<?= $goods->id ?>"></span>&nbsp;&nbsp;<?= $goods->id ?>
                </td>
                ...
                <div class="form-group mb-3">
                    <div class="input-group short-row">
                        <input type="text" step="1" class="form-control short-row" name="integral[give]"
                               value="<?= $goods['integral']['give'] ?>" placeholder="积分赠送">
                ...
                <div class="form-group mb-3">
                    <div class="input-group short-row">
                        ...
                        <input type="text" step="1" class="form-control short-row" name="integral[forehead]"
                               value="<?= $goods['integral']['forehead'] ?>" placeholder="积分抵扣">
