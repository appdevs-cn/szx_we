            ...
            <template v-if="navigation_bar_color!=false">
                <div class="form-group row">
                    ...
                    <div class="col-sm-3" style="padding-top: calc(.5rem - 1px * 2);">
                        ...
                        <label>背景颜色：</label>
                        <input type="color" name="navigation_bar_color[backgroundColor]" v-model="navigation_bar_color.backgroundColor">
                    </div>
                    <div class="col-sm-3" style="padding-top: calc(.5rem - 1px * 2);">
                    ...
                    <div class="col-sm-6">
                        <template v-for="(nav,i) in navbar.navs">
                            <div class="nav-item">
                                ...
                                <div hidden>
                                    <input :name="'navbar[navs]['+i+'][url]'" :value="nav.url">
                                    <input :name="'navbar[navs]['+i+'][icon]'" :value="nav.icon">
                                    <input :name="'navbar[navs]['+i+'][active_icon]'" :value="nav.active_icon">
                                    <input :name="'navbar[navs]['+i+'][text]'" :value="nav.text">
                                    <input :name="'navbar[navs]['+i+'][color]'" :value="nav.color">
                                    <input :name="'navbar[navs]['+i+'][active_color]'" :value="nav.active_color">
                                </div>
                            </div>
                        </template>
