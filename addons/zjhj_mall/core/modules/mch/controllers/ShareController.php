...
//            $cash->type = 2;
    ...
    public function actionDel($id = 0)
    {
        ...
        $count2 = User::updateAll(['is_distributor' => 0, 'parent_id' => 0], 'id=:id', [':id' => $share->user_id]);
