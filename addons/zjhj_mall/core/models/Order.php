...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'user_id', 'is_pay', 'pay_type', 'pay_time', 'is_send', 'send_time', 'is_confirm', 'confirm_time', 'is_comment', 'apply_delete', 'addtime', 'is_delete', 'is_price', 'parent_id', 'is_offline', 'clerk_id', 'is_cancel', 'shop_id', 'user_coupon_id', 'give_integral'], 'integer'],
            ...
            [['address_data', 'content', 'offline_qrcode', 'integral'], 'string'],
